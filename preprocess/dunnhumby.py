...
input_file_path = '../rawdata/dunnhumby/transaction_data.csv'


train_baskets_file_path = '../csvdata/dunnhumby/dunnhumby_train.csv'
test_baskets_file_path = '../csvdata/dunnhumby/dunnhumby_test.csv'
valid_baskets_file_path = '../csvdata/dunnhumby/dunnhumby_valid.csv'
...
'''
with open("../preprocess/truncate_dunn_item_ind.json", "w") as outfile:
    json.dump(item_dict, outfile)
with open("../preprocess/truncate_dunn_user_ind.json", "w") as outfile:
