...
user_order = pd.read_csv('../rawdata/tafeng/ta_feng_all_months_merged.csv',
                         usecols=['TRANSACTION_DT', 'CUSTOMER_ID', 'PRODUCT_ID'])

train_baskets_file_path = '../csvdata/tafeng/tafeng_train.csv'
test_baskets_file_path = '../csvdata/tafeng/tafeng_test.csv'
valid_baskets_file_path = '../csvdata/tafeng/tafeng_valid.csv'
...
'''
with open("../preprocess/truncate_ta_item_ind.json", "w") as outfile:
    json.dump(item_dict, outfile)
with open("../preprocess/truncate_ta_user_ind.json", "w") as outfile:
