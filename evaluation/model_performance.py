...
def get_repeat_eval(pred_folder, dataset, size, number_list, file):
...
def get_eval_input(pred_folder, dataset, number_list, size, file, pweight): #add user_group is str 
