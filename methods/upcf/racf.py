...
if __name__ == '__main__':
    ...
    data_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/mergedata/{dataset}_merged.json'
    ...
    pred_path = f'pred/{dataset}_pred{number}.json'
    rel_path = f'pred/{dataset}_rel{number}.json'
    ...
    with open(f'/ivi/ilps/personal/yliu10/NBR-fairness/methods/upcf/tune/{recency}_{alpha}_{q}.txt', 'w') as f:
        for line in utility:
            f.write(str(line))
            f.write('\n')  
    '''
