...
def train():
    ...
    # train
    model_folder = f"/ivi/ilps/personal/yliu10/NBR-fairness/methods/dnntsp/save_model_folder{seed}/{get_attribute('data')}/{get_attribute('save_model_folder')}"
    tensorboard_folder = f"/ivi/ilps/personal/yliu10/NBR-fairness/methods/dnntsp/runs{seed}/{get_attribute('data')}/{get_attribute('save_model_folder')}"
