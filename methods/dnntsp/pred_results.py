...
if __name__ == '__main__':
    ...
    history_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/jsondata/{dataset}_history.json'
    future_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/jsondata/{dataset}_future.json'
    keyset_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/keyset/{dataset}_keyset_0.json'
    
    pred_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/methods/dnntsp/results/{dataset}_pred{fold}.json'
    pred_rel_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/methods/dnntsp/results/{dataset}_rel{fold}.json'
