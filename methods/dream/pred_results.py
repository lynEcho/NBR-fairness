...
if __name__ == '__main__':
    ...
    history_file = '/ivi/ilps/personal/yliu10/NBR-fairness/jsondata/'+dataset+'_history.json'
    future_file = '/ivi/ilps/personal/yliu10/NBR-fairness/jsondata/'+dataset+'_future.json'
    ...
    for mode in str(attention):
        ...
        keyset_file = '/ivi/ilps/personal/yliu10/NBR-fairness/keyset/'+dataset+'_keyset_'+str(fold_id)+'.json'
        print(keyset_file)
        #pred_file = 'pred/'+dataset+'_'+mode+'_pred'+str(fold_id)+'.json'
        #rel_file = 'pred/'+dataset+'_'+mode+'_rel'+str(fold_id)+'.json'

        pred_file = 'pred/'+dataset+'_pred'+str(number)+'.json'
        rel_file = 'pred/'+dataset+'_rel'+str(number)+'.json'
