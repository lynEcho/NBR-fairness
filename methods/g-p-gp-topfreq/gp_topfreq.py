...
if __name__ == '__main__':
    ...
    data_future = pd.read_csv(f'/ivi/ilps/personal/yliu10/NBR-fairness/csvdata/{dataset}/fold/{dataset}_test.csv')
    ...
    with open(f'gp_top_results/{dataset}_pred{fold_id}.json', 'w') as f:
        json.dump(pred_dict, f)
    with open(f'gp_top_results/{dataset}_rel{fold_id}.json', 'w') as f:
