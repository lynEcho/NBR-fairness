...
if __name__ == '__main__':
    ...
    group_dict = {'group0': [], 'group1': [], 'group2': []}
    '''
    ind = 0
    while ind < len(group_product):

        if group_product.at[ind,'user_id'] <= 10:
            group_dict['group0'].append(int(group_product.at[ind,'product_id']))
        elif group_product.at[ind,'user_id'] >= 11 and group_product.at[ind,'user_id'] <= 41:
            group_dict['group1'].append(int(group_product.at[ind,'product_id']))
        elif group_product.at[ind,'user_id'] >= 42:
            group_dict['group2'].append(int(group_product.at[ind,'product_id']))
        ind += 1
