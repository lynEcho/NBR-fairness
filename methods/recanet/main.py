...
#data_path = 'data/'
data_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/csvdata/{args.dataset}/fold/'
...
pred_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/methods/recanet/results/{args.dataset}_pred{args.foldk}.json'
pred_rel_path = f'/ivi/ilps/personal/yliu10/NBR-fairness/methods/recanet/results/{args.dataset}_rel{args.foldk}.json'
