...
class MLPv12(NBRBase):
    ...
    def predict(self,epoch = '01'):
        ...
        '''
        with open(f'/ivi/ilps/personal/yliu10/NBR-fairness/methods/recanet/tune/{self.user_embed_size}_{self.item_embed_size}.txt', 'w') as f:
            f.write(str(epoch_recall[best_epoch-1]))  
            f.write('\n')  
            f.write(self.data_path+'_weights.'+epoch_str+'.hdf5')
